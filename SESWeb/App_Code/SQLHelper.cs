...
namespace SESWeb
{
    ...
    {
        // Connection String For BI
        public static string strConnBI = ConfigurationManager.ConnectionStrings["BI"].ConnectionString;
        // Connection String For EIS
        public static string strConnEIS = ConfigurationManager.ConnectionStrings["EIS"].ConnectionString;
        //Connection String For NPDI
        public static string strConnNPDI = ConfigurationManager.ConnectionStrings["NPDI"].ConnectionString;
        ...
        // Execute a SqlCommand (that returns a resultset) against the specified SqlConnection
        // using the provided parameters and Filling as existing Dataset.
        // e.g.:
        // Dim ds as Dataset = ExecuteDataset(connString, CommandType.StoredProcedure, "GetOrders", dsSetObject,"tblUsers")
        // Parameters:
        // -connectionString - a valid connection string for a SqlConnection
        // -commandType - the CommandType (stored procedure, text, etc.)
        // -commandText - the stored procedure name or T-SQL command
        // -dsDataSet - an Existing dataset which will be filled with the query
        // -strTableName - the table name under which the record will be filled in the Dataset
        // Returns: a dataset containing the resultset generated by the command
        public static DataSet ExecuteDataset(string connectionString, CommandType commandType, string commandText, DataSet dsDataSet, string strTableName)
        {
            ...
            try
            {
                ...
                //fill the Passed DataSet using default values for DataTable names, etc.
                da.Fill(dsDataSet, strTableName);
        ...
        // -connectionOwnership - indicates whether the connection parameter was provided by the caller, or created by SqlHelper
        // Returns: SqlDataReader containing the results of the command
        public static SqlDataAdapter ExecuteSelectAdapter(string connectionstring, CommandType commandType, string commandText, SqlParameter[] commandParameters)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandTimeout = 10000;
        ...
        public static SqlDataAdapter ExecuteSelectAdapter(SqlConnection connection, CommandType commandType, string commandText, SqlParameter[] commandParameters)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandTimeout = 10000;
            SqlDataAdapter da = new SqlDataAdapter();
        ...
        public static SqlDataAdapter ExecuteSelectAdapter(string connectionstring, CommandType commandType, string commandText)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandTimeout = 10000;
            SqlDataAdapter da = new SqlDataAdapter();
    ...
    public class SqlHelperParameterCache
    {
        ...
        // Retrieves the Connection appropriate for the Connection String
        //
        // This method will create a connection and return the connection for transactional Operations
        // -connectionString - a valid connection string for a SqlConnection
